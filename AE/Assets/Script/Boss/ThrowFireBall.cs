...
public class ThrowFireBall : MonsterProperty
{
    public UnityEvent OnHitFunc;
    public FireSlime myParent = null;

    private void Awake()
    {
        myParent = GetComponentInParent<FireSlime>();
    }
    void Start()
    {
        StartCoroutine(Moving());
        this.attackDamage = myParent.attackDamage + 1;
